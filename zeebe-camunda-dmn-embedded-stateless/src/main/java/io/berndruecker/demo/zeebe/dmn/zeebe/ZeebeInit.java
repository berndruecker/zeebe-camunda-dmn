...
import io.berndruecker.demo.zeebe.dmn.ZeebeWorkerDmnCamundaStatelessApplication;
import io.zeebe.client.ZeebeClient;

@Configuration
public class ZeebeInit {
  
  private static final Logger LOG = LoggerFactory.getLogger(ZeebeWorkerDmnCamundaStatelessApplication.class);
